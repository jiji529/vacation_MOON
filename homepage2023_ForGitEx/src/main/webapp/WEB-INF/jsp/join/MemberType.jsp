		...
		<div class="confirm_box">
			...
			<div class="btn-cont">
				<a class="btn-kakao" href="#" data-type="join">
					<img alt="카카오 로그인 버튼" width="150" src="http://k.kakaocdn.net/14/dn/btroDszwNrM/I6efHub1SN5KCJqLm1Ovx1/o.jpg"/>
				</a>
			</div>
		</div>
	</article>
		...
		<div class="confirm_box">
			...
			<div class="btn-cont">
				<a class="btn-naver" href="${naverAuthUrl}" data-type="join">
					<img alt="네이버 로그인 버튼" width="150" src="/asset/front/images/common/btn-naver.png"/>
				</a>
			</div>
		</div>
	</article>
